...
# pc上
~/software/TensorRT-8.5.3.1/bin/trtexec --onnx=yolo11s-seg.onnx --saveEngine=yolo11s-seg.engine

# orin上
/usr/src/tensorrt/bin/trtexec --onnx=yolo11s-seg.onnx --saveEngine=yolo11s-seg.engine
~~~
...
~~~python
# detect
roslaunch yolo11_ros detect.launch

# pose
roslaunch yolo11_ros pose.launch

# segment
roslaunch yolo11_ros segment.launch
~~~
